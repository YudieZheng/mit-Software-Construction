...
public class MinesweeperServer {
    ...
    private static final String HELPMESSAGE = "Help Message!";
    private static final String BYEMESSAGE = "BYE!";
    public static final String BOOMMESSAGE = "BOOM! BOOM! BOOM!";
    ...
    private void setBoard(File file){
        Board board = new Board(file, DEFAULT_SIZE);
        this.board = board;
    }

    private void HelloMessage(){
        String helloMessage = "Welcome to Minesweeper.\r\n" + 
                              "Board: " + board.getSizeX() + " columns by " + board.getSizeY() + "rows.\r\n" +
                              "Players: " + playersNum + " including you. TYpe 'help' for help";
    ...
    private void handleConnection(Socket socket) throws IOException {
        ...
        try {
            for (String line = in.readLine(); line != null; line = in.readLine()) {
                ...
                if (output != null) {
                    out.println(output);
                    if (output.equals(BOOMMESSAGE) && !debug){
